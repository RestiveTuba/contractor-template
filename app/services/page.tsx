...
export const metadata: Metadata = {
  title: `Services in ${primaryTown()} | ${config.businessName}`,
  description: `${siteConfig.services.join(", ")} across ${serviceArea()}. Licensed and insured. ${siteDescription()}`,
};
        ...
        <section className="bg-charcoal-deep pt-32 sm:pt-40 pb-16 sm:pb-20">
          <div className="max-w-7xl mx-auto px-5 sm:px-8">
            ...
            <p className="mt-6 font-body text-white/70 text-base sm:text-lg max-w-xl leading-relaxed">
              Every job starts with a clear estimate and ends with a clean site. Pick a
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {siteConfig.services.map((svc) => (
                <ServiceCard
                  key={svc}
                  title={svc}
                  description={`Professional ${svc.toLowerCase()} from a licensed, insured local team, done right the first time.`}
